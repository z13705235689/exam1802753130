...
import com.zbw.server.Exam1802753130App;
import com.zbw.server.config.Constants;
import com.zbw.server.domain.User;
import com.zbw.server.repository.AuthorityRepository;
import com.zbw.server.repository.UserRepository;
import com.zbw.server.security.AuthoritiesConstants;
import com.zbw.server.service.UserService;
import com.zbw.server.service.dto.PasswordChangeDTO;
...
import static com.zbw.server.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = Exam1802753130App.class)
